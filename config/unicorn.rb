...
pid_file   = "#{deploy_to}/unicorn/shared/pids/unicorn.pid"
socket_file= "#{deploy_to}/unicorn/shared/unicorn.sock"
log_file   = "#{rails_root}/unicorn/log/unicorn.log"
err_log    = "#{rails_root}/unicorn/log/unicorn_error.log"
